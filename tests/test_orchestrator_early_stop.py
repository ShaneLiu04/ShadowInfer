...
class TestOrchestratorEarlyStop:
    def test_early_stop_triggered(self):
        ...
        orch.initialize(model_config={"name": "test", "num_layers": 2, "num_heads": 2, "head_dim": 8, "hidden_dim": 16, "intermediate_dim": 32, "batch_size": 1, "seq_len": 4})
        ...
        assert any(
            "early_stop" in step.get("outputs", {})
