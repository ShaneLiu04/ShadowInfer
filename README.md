...
```bash
git clone https://github.com/ftlxy/ShadowInfer.git
cd ShadowInfer
...
- 在 [GitHub Issues](https://github.com/ftlxy/ShadowInfer/issues) 报告 bug 或提出需求；
- 在 [Pull Requests](https://github.com/ftlxy/ShadowInfer/pulls) 提交改进；
- 改进文档、教程或翻译；
- 分享你的使用场景与复现结果。
